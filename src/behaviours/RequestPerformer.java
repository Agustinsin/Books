...
public class RequestPerformer extends Behaviour{
    ...
    case 3:      
      ...
      if (reply != null) {
         if (reply.getPerformative() == ACLMessage.INFORM) {
            ...
            JOptionPane.showMessageDialog(null, "El libro "+bookTitle+" ha sido vendido\nPrecio: $"+bestPrice);
            myAgent.doDelete();
         }
         else {
            System.out.println("Attempt failed: requested book already sold.");
            JOptionPane.showMessageDialog(null, "Hubo un fallo. El libro "+bookTitle+" ha sido vendido");
         }
  ...
  public boolean done() {
    if (step == 2 && bestSeller == null) {
       ...
       JOptionPane.showMessageDialog(null, "El libro "+ bookTitle +" no esta disponible");
       myAgent.doDelete();
    }
